...
const ProductDetails = () => {
    ...
    useEffect(() => {
        if (id) {
            axios.get(`http://localhost:7070/product/get/${id}`)
                .then(response => {
            ...
            axios.get(`http://localhost:7070/review/get/${id}`)
                .then(response => {
    ...
    const loadProducts=async()=>{
        const result = await axios.get("http://localhost:7070/product");
    ...
    await axios.get(`http://localhost:7070/cart/get/${customerId}`)
    .then((respnse) =>{
     ...
     if(cartId == 0){
       ...
       console.log("cart dto in else" + cartDto.cartId)
        ...
        await axios.post("http://localhost:7070/order/add",cartDto)
        .then((response) => {
